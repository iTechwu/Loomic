 ...
 * content later from TOS/CDN without touching the UI layer.
 */
export const homeDiscoverySeedCategories: HomeDiscoveryCategory[] = [
  createCategory("branding-design", "品牌设计", [
    createCase(
      ...
      "https://assets.dofe.ai/home-seeds/discovery/branding-design/cover.webp",
      "Studio Arken",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/branding-design.svg",
      549,
      7,
  ...
  createCategory("poster-and-ads", "海报与广告", [
    createCase(
      "n9d21de",
      "Vintage Car Poster",
      "https://assets.dofe.ai/home-seeds/discovery/poster-and-ads/cover.webp",
      "Retro Workshop",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/poster-and-ads.svg",
      359919,
      286,
  ...
  createCategory("illustration", "插画", [
    createCase(
      "bjde0nh",
      "Cat Tarot Cards",
      "https://assets.dofe.ai/home-seeds/discovery/illustration/cover.webp",
      "Mochi Art",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/illustration.svg",
      2054,
      116,
  ...
  createCategory("ui-design", "UI设计", [
    createCase(
      ...
      "https://assets.dofe.ai/home-seeds/discovery/ui-design/cover.webp",
      "Pixel Forge",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/ui-design.svg",
      4338,
      192,
  ...
  createCategory("character-design", "角色设计", [
    createCase(
      ...
      "https://assets.dofe.ai/home-seeds/discovery/character-design/cover.webp",
      "Dark Carnival",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/character-design.svg",
      749,
      12,
  ...
  createCategory("storyboard-video", "影片与分镜", [
    createCase(
      "ikqo02k",
      "Mixtapes Emotions !",
      "https://assets.dofe.ai/home-seeds/discovery/storyboard-video/cover.webp",
      "Frame Studio",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/storyboard-video.svg",
      3057,
      49,
  ...
  createCategory("product-design", "产品设计", [
    createCase(
      ...
      "https://assets.dofe.ai/home-seeds/discovery/product-design/cover.webp",
      "Future Lab",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/product-design.svg",
      769,
      27,
  ...
  createCategory("architecture-design", "建筑设计", [
    createCase(
      ...
      "https://assets.dofe.ai/home-seeds/discovery/architecture-design/cover.webp",
      "Arc Design",
      "https://assets.dofe.ai/home-seeds/discovery/avatars/architecture-design.svg",
      1453,
      24,
